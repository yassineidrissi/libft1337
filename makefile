...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c \
  ...
  ft_strrchr.c ft_strncmp.c ft_memchr.c ft_memcmp.c ft_strnstr.c ft_strdup.c ft_strjoin.c ft_itoa.c\
  ft_itoa.c ft_strmapi.c ft_substr.c ft_striteri.c ft_putchar_fd.c ft_putnbr_fd.c ft_putstr_fd.c ft_split.c
OBG = ${SRC:.c=.o} 
NAME = libft.a
RM = rm -rf
AR = ar -rc
